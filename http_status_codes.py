...
class HTTPStatusCodes:
    ...
    *5xx = server error responses*
    ...
    CODE_101_SWITCHING_PROTOCOLS: Literal[101]
        101 Switching Protocols.
        
        This code is sent in response to an Upgrade request header from the client and indicates the protocol the server is switching to.
        
    CODE_102_PROCESSING: Literal[102]
        102 Processing (WebDAV).

        This code indicates that the server has received and is processing the request, but no response is available yet.
        
    CODE_103_EARLY_HINTS: Literal[103]
        103 Early Hints.
    ...
    CODE_200_OK_SUCCESS: Literal[200]
        200 OK.
    ...
    CODE_203_NON_AUTHORITATIVE_INFORMATION: Literal[203]
    ...
    CODE_204_NO_CONTENT: Literal[204]
        204 No Content.
